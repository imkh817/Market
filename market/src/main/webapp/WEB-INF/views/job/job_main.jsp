...
.write_btn:hover {
    background-color: #E5D85C; /* 마우스 오버시 배경색 변경 */
    color: #353535; /* 마우스 오버시 글자색 변경 */
}
</style>
</head>
<body style="padding-top: 40px;">
	...
	<section class="banner my-5 py-5">
		<div class="title">
			...
			<c:if test="${member_id != null }">
				<button class="write_btn btn btn-sm mt-3 fw-bold"
					onClick="location.href='job_insert_form'">구인하기</button>
			</c:if>
		</div>
	</section>
	...
	<div class="position-relative">
		...
		<div
			class="row row-cols-1 row-cols-md-3 d-flex justify-content-center"
			style="max-width: 768px; position: relative; margin: 0 auto;">
			...
			<nav aria-label="Page navigation example"
				style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); background-color: white; z-index: 100;">
