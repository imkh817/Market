...
<br>
<form action="lowest_baechu" method="post" class="d-flex me-auto w-25 mx-auto" role="search" id="search" style="text-align: center;">
    <input class="form-control me-2 px-2" type="search" id="compare_product" name="compare_product"
           placeholder="최저가 비교할 물품명을 입력해주세요" aria-label="Search"
           style="border-color: #21F11C; width: 100%;">
    <i class="fa-solid fa-magnifying-glass" style="color: #21F11C;"></i>
</form>
<br>
<div class="lowest_price" align="center">
    <a href="lowest_baechu_form" style="color: #21F11C;">양배추 마켓 최저가</a>&nbsp; &nbsp;|&nbsp; &nbsp;<a href ="lowest_naver_form" >네이버 신제품 최저가</a>
</div>

<c:if test="${list != null }">
	<br><br>
	<div style="border: 1px solid #008000; background-color: #E0FFE0; padding: 10px; margin: 10px auto; max-width: 700px;"class="rounded-4 shadow p-3 mb-5 bg-body-tertiary rounded">
		...
		<br>
		<div class="price" align="center">
			<div><span >평균 </span><span class="fs-4 fw-bolder opacity-75">${compare_price.avg_price}원</span></div>
			<div><span class="text-danger">최고 </span><span class="text-danger fs-4 fw-bolder opacity-75">${compare_price.high_price}원</span></div>
			<div><span class="text-primary">최저 </span> <span class="text-primary fs-4 fw-bolder opacity-75">${compare_price.low_price}원</span></div>
		</div>
	</div>
		...
		<div class="row row-cols-1 row-cols-md-3" style="max-width: 800px;">
			<c:forEach var="list" items="${list}">
				<div class="col">
					...
					<a href="#">
						<img src="${list.goods_image}" class="card-img-top mx-auto my-2" alt=""
